...
import { PageTitle, CircularIndeterminate, APIDATA, colors } from "../../Constant"
...
const APIDATAA = 'https://bellefu.inmotionhub.xyz/api/v3/get/all/commercial'
                            ...
                            .map((row) => (
                                ...
                                >
                                    <TableCell component="th" scope="row">
                                        <img
                                            src={`https://bellefu.inmotionhub.xyz/get/commercial/image/${row.image}`}
                                            alt="error"
                                            style={imgStyle}
                                        />
                                    ...
                                    <TableCell >
                                        <Box >
                                            ...
                                            <Tooltip title='Delete'>
                                                ...
                                                >
                                                    <Icons.DeleteOutlineOutlined sx={{ color: "red" }} />
                                                </IconButton>
                                            </Tooltip>
                                            ...
                                            >
                                                <Box sx={modal.edit}>
                                                    ...
                                                    <Typography sx={{ p: 1, ml: 3, mb: 6 }} variant="p"> Do you want to delete this Advert ? </Typography>
                                                    ...
                                                    <Box sx={{ mt: 5, display: "flex", justifyContent: 'space-between', m: 4, mb: 5 }}>
                                                        ...
                                                        <Button variant="contained" sx={{ color: '#ffff', bgcolor: '#76ba1b' }} onClick={verify} >Delete</Button>
                                                    </Box>
                                                </Box>
                                            </Modal>
