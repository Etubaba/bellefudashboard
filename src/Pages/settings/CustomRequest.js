...
export default function AdminList() {
    ...
    useEffect(() => {
        ...
        const getprogram = async () => {
            await axios.get(`${APIDATA}list/custom/request`)
                                ...
                                >
                                    ...
                                    <TableCell >
                                        <Box >
                                            ...
                                            {row.image !== null && <Tooltip title='View Image'>
                                                <IconButton
                                                    onClick={() => {
                                                        setPushId(row.id)
                                                        setOpen2(true)
                                            ...
                                            >
                                                <Box sx={modal.edit}>
                                                    ...
                                                    <Typography sx={{ p: 1, ml: 3, mb: 6 }} variant="p"> Do you want to delete this request ? </Typography>
