...
const FilesUploadedTable = () => {
  ...
  useEffect(() => {
    ...
    const getprogram = async () => {
      await axios.get(`${APIDATA}sliders/list`)
  ...
  return (
    ...
    <TableContainer component={Paper} sx={{ marginBottom: '3rem' }}>
      <Table aria-label="files upload table">
        ...
        <TableBody>
          {upload === null ? <CircularIndeterminate /> : upload
                ...
                <TableCell variant="body">
                  ...
                  >
                    <Box sx={edit}>
                      ...
                      <Typography sx={{ p: 1, ml: 3, mb: 6 }} variant="p"> Do you want to delete this slider ? </Typography>



                      <Divider sx={{ mt: 5, mb: 5 }} />
                      <Box sx={{ mt: 5, display: "flex", bgColor: 'grey', justifyContent: 'space-between', m: 4, mb: 5 }}>
                        <Button variant="contained" sx={{ bgcolor: '#76ba1b' }} onClick={() => setOpen(false)}>cancel</Button>
