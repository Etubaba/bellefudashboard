...
export default function AdminList() {
    ...
    useEffect(() => {
        ...
        const getprogram = async () => {
            await axios.get(`${APIDATA}verification/id/list`)
    ...
    return (
        <Box>
            <Box style={{ display: "flex", justifyContent: "space-between" }}>
                <PageTitle title="ID Verification" variant="h4" component="h2" />
                                            ...
                                            >
                                                <Box sx={modal.edit}>
                                                    ...
                                                    <Box sx={{ mt: 5, display: "flex", justifyContent: 'space-between', m: 4, mb: 5 }}>
                                                        ...
                                                        <Button variant="contained" sx={{ color: '#ffff', bgcolor: '#76ba1b' }} onClick={verify} >Verify</Button>
                                                    </Box>
                                                </Box>
                                            </Modal>
