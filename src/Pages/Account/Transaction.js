...
export default function AdminList() {
    ...
    useEffect(() => {
        ...
        const getprogram = async () => {
            await axios.get(`${APIDATA}list/transaction`)
    ...
    const modalstyle = {
        width: 750, padding: '20px', margin: 'auto 25%', position: 'absolute', top: '10%'
    }
    return (
        <Box>
            <Box style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <FormControl sx={{ m: 1, width: '30ch' }} variant="outlined">
                    <OutlinedInput
                        ...
                        endAdornment={<InputAdornment position="end"><IconButton><Icons.Search /></IconButton></InputAdornment>}
                        ...
                        {program === null ? <CircularIndeterminate /> : program
                            ...
                            .map((row) => (
                                ...
                                >
                                    ...
                                    <TableCell >
                                        <Typography sx={{ borderRadius: 2, textAlign: 'center', p: 0.5, bgcolor: '#76ba1b', color: '#ffff' }}>Completed</Typography>
                                    </TableCell>
                                </TableRow>
                            ))}
                    </TableBody>
