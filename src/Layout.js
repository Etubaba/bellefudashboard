...
export default function MiniDrawer() {
    ...
    return (
        <Box sx={{ display: "flex" }}>
            ...
            <Drawer variant="permanent" open={open}>
                <DrawerHeader>
                    ...
                    {open ?
                        <div>
                            <Box
                                style={{ padding: '1.3%', display: 'flex' }}
                            >
                                <img
                                ...
                                />
                                <IconButton sx={{ marginLeft: 3, position: 'relative', top: '-15%' }} onClick={handleDrawerClose}>
                ...
                <List>
                    ...
                    <Collapse in={products} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            ...
                            >
                                <ListItem button sx={{ pl: 6 }}>
                                    <ListItemIcon>
                                        <Icons.RemoveShoppingCartOutlined sx={{ color: "rgb(118 186 27)" }} />
                                    </ListItemIcon>
                    ...
                    <Collapse in={Voucher} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            ...
                            >
                                <ListItem button sx={{ pl: 6 }}>
                                    <ListItemIcon>
                                        <Icons.CreditScoreOutlined sx={{ color: "rgb(118 186 27)" }} />
                                    </ListItemIcon>
                    ...
                    <ListItem button onClick={() => setCat(!cat)}>
                        <ListItemIcon>
                            <Icons.AutoAwesomeMosaicOutlined sx={{ color: "rgb(118 186 27)" }} />
                        </ListItemIcon>
                    ...
                    <Collapse in={cat} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            ...
                            >
                                <ListItem button sx={{ pl: 6 }}>
                                    <ListItemIcon>
                                        <Icons.PlaylistAddOutlined sx={{ color: "rgb(118 186 27)" }} />
                                    </ListItemIcon>
                    ...
                    <Collapse in={account} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            ...
                            >
                                ...
                                <ListItem button sx={{ pl: 6 }}>
                                    <ListItemIcon>
                                        <Icons.ManageAccountsOutlined sx={{ color: "rgb(118 186 27)" }} />
                                    </ListItemIcon>
                            ...
                            >
                                ...
                                <ListItem button sx={{ pl: 6 }}>
                                    <ListItemIcon>
                                        <Icons.ReceiptLongOutlined sx={{ color: "rgb(118 186 27)" }} />
                                    </ListItemIcon>
                    ...
                    <Collapse in={report} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            ...
                            >
                                <ListItem button sx={{ pl: 6 }}>
                                    <ListItemIcon>
                                        <Icons.ReportGmailerrorred sx={{ color: "rgb(118 186 27)" }} />
                                    </ListItemIcon>
            ...
            <Box component="main" sx={{ flexGrow: 1, p: 3, backgroundColor: colors.backG }}>
                <DrawerHeader />
                <Outlet />
            </Box>
        </Box>
